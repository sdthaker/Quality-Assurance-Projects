...
suite('Unit Tests', function () {
  ...
  suite('Equality', function () {
    ...
    test('#equal, #notEqual', function () {
      assert.equal(12, '12', 'numbers are coerced into strings with ==, 12 == 12 (regardless of the type)');
      assert.notEqual({ value: 1 }, { value: 1 }, '== compares object references, both the objects have their own references');
      assert.equal(6 * '2', '12', '\'12\' == \'12\'');
      assert.notEqual(6 + '2', '12', '8 != 12 (regardless of the type)');
    });
    // #6
